    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="relative">
            ...
            {ifaceOpen && (
              <div className={`absolute top-full left-0 mt-1 border rounded-md shadow-xl z-20 min-w-[100px] overflow-hidden ${
                isDark
                ...
                {INTERFACES.map((n) => (
                  <button
                    ...
                    className={`block w-full text-left text-xs font-mono px-3 py-1.5 transition-colors duration-150 ${
                      n === iface
      ...
      >
        <button
          ...
          className={`group relative flex items-center gap-3 px-8 py-3 rounded-xl text-sm font-bold tracking-wide transition-all duration-300 ${
            isActive
              ? 'bg-slate-600/20 text-slate-300 hover:bg-red-500/15 hover:text-red-400 border border-slate-500/30 hover:border-red-500/40'
              : 'bg-blue-600 text-white hover:bg-blue-500 border border-blue-400/30 shadow-[0_0_20px_rgba(59,130,246,0.25)] hover:shadow-[0_0_28px_rgba(59,130,246,0.4)]'
          }`}
        >
          {isActive ? (
